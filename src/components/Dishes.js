...
let Dishes = () => {
    ...
    //useEffect callback runs first when the component gets rendered.
    ...
    const [randomText,setRandomText] = useState("Random text 1");
    // let randomText = "Random text 1";
    return (
        <div>
             ...
             <button onClick={()=>{
                setRandomText("Random text 2");
             }}>Change random text</button>
             <br/>
             <br/>
